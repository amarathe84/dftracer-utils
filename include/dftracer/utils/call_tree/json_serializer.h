...
public:
     ...
     * @return Number of bytes written
     */
    size_t serialize_node(char* buffer, int index, 
     ...
     * @return Number of bytes written
     */
    size_t serialize_metadata(char* buffer,
...
private:
     ...
     */
    bool convert_args_to_json(const std::unordered_map<std::string, std::string>& args,
