#ifndef DFTRACER_UTILS_PIPELINE_EXECUTORS_THREAD_TASK_QUEUE_H
#define DFTRACER_UTILS_PIPELINE_EXECUTORS_THREAD_TASK_QUEUE_H
...
struct TaskItem {
    ...
    TaskItem(TaskItem&& other) noexcept 
        : task_id(other.task_id), task_ptr(other.task_ptr), 
          input(std::move(other.input)), completion_callback(std::move(other.completion_callback)) {
        other.task_id = -1;
...
#endif  // DFTRACER_UTILS_PIPELINE_EXECUTORS_THREAD_TASK_QUEUE_H
