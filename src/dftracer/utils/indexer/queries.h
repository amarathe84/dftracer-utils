...
void insert_file_record(SqliteDatabase &db,
                        const std::string &gz_path_logical_path_,
...
void insert_file_metadata_record(SqliteDatabase &db, int file_id,
...
void insert_checkpoint(SqliteDatabase &db, int file_id,
