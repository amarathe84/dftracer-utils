...
static PyObject *
IndexCheckpoint_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
...
static PyMemberDef IndexCheckpoint_members[] = {
    {"checkpoint_idx", T_ULONGLONG, offsetof(IndexCheckpointObject, checkpoint.checkpoint_idx), 0,
     "Checkpoint index"},
    {"uc_offset", T_ULONGLONG, offsetof(IndexCheckpointObject, checkpoint.uc_offset), 0,
     "Uncompressed offset"},
    {"uc_size", T_ULONGLONG, offsetof(IndexCheckpointObject, checkpoint.uc_size), 0,
     "Uncompressed size"},
    {"c_offset", T_ULONGLONG, offsetof(IndexCheckpointObject, checkpoint.c_offset), 0,
     "Compressed offset"},
    {"c_size", T_ULONGLONG, offsetof(IndexCheckpointObject, checkpoint.c_size), 0,
     "Compressed size"},
    {"bits", T_UINT, offsetof(IndexCheckpointObject, checkpoint.bits), 0,
     "Bit position"},
    {"num_lines", T_ULONGLONG, offsetof(IndexCheckpointObject, checkpoint.num_lines), 0,
...
PyTypeObject IndexCheckpointType = {
    ...
    "indexer.IndexCheckpoint",             /* tp_name */
...
static void
DFTracerIndexer_dealloc(DFTracerIndexerObject *self)
{
    if (self->handle) {
...
static PyObject *
DFTracerIndexer_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
...
static int
DFTracerIndexer_init(DFTracerIndexerObject *self, PyObject *args, PyObject *kwds)
{
    static const char *kwlist[] = {"gz_path", "idx_path", "checkpoint_size", "force_rebuild", NULL};
    const char *gz_path;
    ...
    self->handle = dft_indexer_create(gz_path, idx_path_str, checkpoint_size, force_rebuild);
    if (!self->handle) {
...
static PyObject *
DFTracerIndexer_build(DFTracerIndexerObject *self, PyObject *Py_UNUSED(ignored))
{
    if (!self->handle) {
...
static PyObject *
DFTracerIndexer_need_rebuild(DFTracerIndexerObject *self, PyObject *Py_UNUSED(ignored))
{
    if (!self->handle) {
        PyErr_SetString(PyExc_RuntimeError, "Indexer not initialized");
        return NULL;
...
static PyObject *
DFTracerIndexer_exists(DFTracerIndexerObject *self, PyObject *Py_UNUSED(ignored))
{
    if (!self->handle) {
        PyErr_SetString(PyExc_RuntimeError, "Indexer not initialized");
        return NULL;
...
static PyObject *
DFTracerIndexer_get_max_bytes(DFTracerIndexerObject *self, PyObject *Py_UNUSED(ignored))
{
    if (!self->handle) {
        PyErr_SetString(PyExc_RuntimeError, "Indexer not initialized");
        return NULL;
...
static PyObject *
DFTracerIndexer_get_num_lines(DFTracerIndexerObject *self, PyObject *Py_UNUSED(ignored))
{
    if (!self->handle) {
        PyErr_SetString(PyExc_RuntimeError, "Indexer not initialized");
        return NULL;
...
static PyObject *
DFTracerIndexer_find_checkpoint(DFTracerIndexerObject *self, PyObject *args)
{
    if (!self->handle) {
        PyErr_SetString(PyExc_RuntimeError, "Indexer not initialized");
        return NULL;
    ...
    int found = dft_indexer_find_checkpoint(self->handle, target_offset, &checkpoint);
    ...
    IndexCheckpointObject *cp_obj = (IndexCheckpointObject *)IndexCheckpoint_new(&IndexCheckpointType, NULL, NULL);
    if (!cp_obj) {
        return NULL;
    }
...
static PyObject *
DFTracerIndexer_get_checkpoints(DFTracerIndexerObject *self, PyObject *Py_UNUSED(ignored))
{
    if (!self->handle) {
        PyErr_SetString(PyExc_RuntimeError, "Indexer not initialized");
        return NULL;
    ...
    int result = dft_indexer_get_checkpoints(self->handle, &checkpoints, &count);
...
static PyObject *
DFTracerIndexer_gz_path(DFTracerIndexerObject *self, void *closure)
{
...
static PyObject *
DFTracerIndexer_idx_path(DFTracerIndexerObject *self, void *closure)
{
...
static PyObject *
DFTracerIndexer_checkpoint_size(DFTracerIndexerObject *self, void *closure)
{
...
static PyMethodDef DFTracerIndexer_methods[] = {
    ...
    {"find_checkpoint", (PyCFunction)DFTracerIndexer_find_checkpoint, METH_VARARGS,
     "Find the best checkpoint for a given uncompressed offset"},
    {"get_checkpoints", (PyCFunction)DFTracerIndexer_get_checkpoints, METH_NOARGS,
     "Get all checkpoints for this file as a list"},
    {NULL}  /* Sentinel */
};

static PyGetSetDef DFTracerIndexer_getsetters[] = {
    {"gz_path", (getter)DFTracerIndexer_gz_path, NULL,
...
PyTypeObject DFTracerIndexerType = {
    PyVarObject_HEAD_INIT(NULL, 0)
    "indexer.DFTracerIndexer",             /* tp_name */
