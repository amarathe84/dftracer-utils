...
# Function to enable comprehensive compiler warnings for a target
...
function(target_set_warnings TARGET_NAME)
    ...
    if(MSVC)
        ...
        if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
            target_compile_options(${TARGET_NAME} PRIVATE
                -Wmove                  # Warn about move semantics issues
                ...
                -Wimplicit-int-float-conversion  # Warn about implicit int to float conversions
    ...
    if(WARNINGS_WARNINGS_AS_ERRORS)
        message(STATUS "Warnings will be treated as errors for target: ${TARGET_NAME}")
    endif()
endfunction()
